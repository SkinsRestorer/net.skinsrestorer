  	...
  	<div class="footer-copyright">
    	<div class="container">
    		...
    		<span class="right">
				...
				<a class="grey-text text-darken-4 btn btn-flat btn-small waves-effect" href="https://github.com/aljaxus/net.skinsrestorer" target="_blank" title="Website's GitHub repo"><i class="fab fa-github fa-lg"></i></a>
			</span>
    	</div>
  	</div>
</footer>
